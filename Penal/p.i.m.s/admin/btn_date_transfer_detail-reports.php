        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Transfer Report</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Admin</span>
                    ...
                    <div class="row">
                        ...
                        <div id="print" class="col-md-12">
                            ...
                            <table class="table table-hover" id="sample-table-1">
                                ...
                                <tbody>
                                <?php
                                $sql=mysqli_query($con,"select transfer.inmate_id, Inmate_FirstName,Inmate_LastName, FileNumber, FromPrison, ToPrison, TransferDate from transfer inner join inmate_details on transfer.inmate_id = inmate_details.Inmate_Id");
