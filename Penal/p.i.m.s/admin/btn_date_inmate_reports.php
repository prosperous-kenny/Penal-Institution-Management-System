        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Choose Date</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Choose</span>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">Choose Date</h5>
                                        </div>
                                        <div class="panel-body">

                                            <form role="form" method="post" action="btn_date_inmate_detail-reports.php">
