...
$receiver= 'receiver';
$isread=1;
$query=mysqli_query($con,"update feedback set feedback_details='$adminremark',IsRead='$isread' where id='$qid'");
if($query){
echo "<script>alert('Feedback is sent');</script>";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">View <span class="text-bold">Feedback</span></h5>
									<table class="table table-hover" id="sample-table-1">

										<tbody>
<?php
$qid=intval($_GET['id']);
$sql=mysqli_query($con,"select * from feedback where id='$qid'");
$cnt=1;
...
?>
											...
											<tr>
												<th>Inmate's Obedience</th>
                                                <td><?php echo $row['Obedience'];?></td>
											</tr>

                                            <tr>
                                            <th>Inmate's Efficiency</th>
                                            <td><?php echo $row['Efficiency'];?></td>
                                            </tr>

                                            <tr>
                                            <th>Inmate's TeamWork</th>
                                            <td><?php echo $row['TeamWork'];?></td>
                                            </tr>

                                            <tr>
											<th> Staff's Message</th>
