...
if(isset($_POST['submit']))
{
    ...
    // Updating to the database 'p.i.m.s'
        $sql=mysqli_query($con, "Update staff set staff_firstname='$userfirstname',staff_lastname='$userlastname',Email='$email' where id='$jid'");
    if($sql)
    {
        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Edit Jailor Info</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Admin</span>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">Edit jailor info</h5>
                                        </div>
                                        <div class="panel-body">
                                            <?php $sql=mysqli_query($con,"select * from staff where id='$jid'");
