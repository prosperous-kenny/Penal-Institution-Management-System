...
if(isset($_POST['submit']))
{
    ...
    // Updating to the database 'p.i.m.s'
        $sql=mysqli_query($con, "Update staff set staff_firstname='$userfirstname',staff_lastname='$userlastname',Email='$email' where id='$mid'");
    if($sql)
    {
...
<html lang="en">
<head>
    <title>Edit Interior Staff Info </title>
        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Edit Interior Staff Info</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Admin</span>
                            ...
                            <li class="active">
                                <span>Edit Interior Staff Info</span>
                            </li>
                        </ol>
                    </div>
                </section>
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h5 class="panel-title">Edit interior-staff info</h5>
                                        </div>
                                        <div class="panel-body">
                                            <?php $sql=mysqli_query($con,"select * from staff where id='$mid'");
