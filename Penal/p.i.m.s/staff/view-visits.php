        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">  Visit Details</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Jailor</span>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php
                            $vid=$_GET['viewid'];
                            $ret=mysqli_query($con,"select *, Inmate_FirstName, Inmate_LastName from visitor_details join  inmate_details on inmate_details.Inmate_Id = visitor_details.Inmate_ID");
                            $cnt=1;
