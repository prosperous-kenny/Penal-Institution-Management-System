 ...
 */
	 ...
	 * __Examples__
	 *
	 *	// provided a container with an Inmate_Id of "tree", and a nested node with an Inmate_Id of "branch"
	...
	$.jstree.core.prototype = {
		...
		/**
		 * get the JSON representation of a node (or the actual jQuery extended DOM node) by using any input (child DOM element, Inmate_Id string, selector, etc)
		 ...
		 * @param  {Boolean} ids if set to true build the path using Inmate_Id, otherwise node text is used
		 * @return {mixed}
		 */
		...
		/**
		 * get the parent Inmate_Id of a node
		 * @name get_parent(obj)
		 * @param  {mixed} obj
		 * @return {String}
		 */
		...
		_append_html_data : function (dom, data, cb) {
			 ...
			 * @param {String} parent the parent Inmate_Id of the nodes
			 */
		 ...
		 * @param  {String} p the parent Inmate_Id
		 * @param  {Array} ps list of all parents
		 * @return {String} the Inmate_Id of the object added to the model
		 */
		...
		/**
		 * set (change) the Inmate_Id of a node
		 * @name set_id(obj, id)
		 * @param  {mixed} obj the node
		 * @param  {String} id the new Inmate_Id
		 * @return {Boolean}
		 */
		set_id : function (obj, id) {
			...
			id = id.toString();
			// update parents (replace current Inmate_Id with new one in children and children_d)
			m[obj.parent].children[$.inArray(obj.id, m[obj.parent].children)] = id;
			for(i = 0, j = obj.parents.length; i < j; i++) {
				m[obj.parents[i]].children_d[$.inArray(obj.id, m[obj.parents[i]].children_d)] = id;
			}
			// update children (replace current Inmate_Id with new one in parent and parents)
			for(i = 0, j = obj.children.length; i < j; i++) {
		 ...
		 * @param  {Boolean} options.no_id do not return Inmate_Id
		 ...
		 * @return {String}            the Inmate_Id of the newly create node
		...
		create_node : function (par, node, pos, callback, is_loaded) {
			 ...
			 * @param {Object} node
			 * @param {String} parent the parent's Inmate_Id
		...
		paste : function (obj, pos) {
			...
			if(this[ccp_mode](ccp_node, obj, pos, false, false, false, ccp_inst)) {
				 ...
				 * @event
				 * @name paste.jstree
				 * @param {String} parent the Inmate_Id of the receiving node
 ...
 */
	...
	$.jstree.defaults.search = {
		 ...
		 * Leave this setting as `false` to not query the server. You can also set this to a function, which will be invoked in the instance's scope and receive 3 parameters - the search string, the callback to call with the array of nodes to load, and the optional node Inmate_Id to limit the search to 
