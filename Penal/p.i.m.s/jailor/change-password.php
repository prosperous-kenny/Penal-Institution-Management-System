...
{
$sql=mysqli_query($con,"SELECT password FROM  staff where password='".md5($_POST['cpass'])."' and staff_Id='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
    $con=mysqli_query($con,"update staff set password='".md5($_POST['npass'])."', updationDate='$currentTime' where staff_Id ='".$_SESSION['login']."'");
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												<div class="panel-body">
                                                    ...
                                                    <p style="color:green;"><?php echo htmlentities($_SESSION['msg2']);?><?php echo htmlentities($_SESSION['msg2']="");?></p>
